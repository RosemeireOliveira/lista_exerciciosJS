...
import { exercicio01, exercicio02,exercicio03,exercicio04, exercicio05, exercicio06 } from "./moduleExercicios.js";
let prompt = promptSync()
let resposta;

do {
    console.log("Apresentação do exercicio")
    resposta = prompt("digite o numero  do exercicio desejado ou clique em 'sair'")
    switch (resposta) {
        case "1":
